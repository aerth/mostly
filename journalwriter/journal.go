...
// This file is a modified version of the journal package from the CoreOS
// From: github.com/coreos/go-systemd v0.0.0-20191104093116-d3cd4ed1dbcf
...
func validVarName(name string) error {
	if name == "" {
		return ErrVarNameEmpty
	}
	if name[0] == '_' {
		return ErrVarNameUnderscore
	}
